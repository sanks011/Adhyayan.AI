      ...
      <div className="relative z-10 container mx-auto px-4 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            {/* FAQ Section */}
            <div className="mt-12">
              <h3 className="text-xl font-semibold mb-6 text-white">अक्सर पूछे जाने वाले प्रश्न</h3>
              <div className="space-y-4">
                <div className="bg-gray-900/30 p-4 rounded-lg border border-gray-800">
                  <h4 className="font-medium mb-2 text-white">आप कितनी जल्दी जवाब देते हैं?</h4>
                  <p className="text-sm text-gray-300">हम आमतौर पर कार्यदिवसों में 24 घंटे के भीतर सभी पूछताछ का जवाब देते हैं।</p>
                </div>
                <div className="bg-gray-900/30 p-4 rounded-lg border border-gray-800">
                  <h4 className="font-medium mb-2 text-white">आपसे संपर्क करने का सबसे अच्छा तरीका क्या है?</h4>
                  <p className="text-sm text-gray-300">
                    सामान्य पूछताछ के लिए, ईमेल को प्राथमिकता दी जाती है। तत्काल मामलों के लिए, कृपया हमें सीधे कॉल करें।
                  </p>
                </div>
                <div className="bg-gray-900/30 p-4 rounded-lg border border-gray-800">
                  <h4 className="font-medium mb-2 text-white">क्या आप कार्यालय समय के बाहर सहायता प्रदान करते हैं?</h4>
                  <p className="text-sm text-gray-300">
                    जबकि हमारे कार्यालय के घंटे ऊपर सूचीबद्ध हैं, हम नियमित रूप से ईमेल की निगरानी करते हैं और जल्द से जल्द जवाब देंगे।
                  </p>
                </div>
              </div>
            </div>
