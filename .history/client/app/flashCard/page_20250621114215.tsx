        ...
        >
          ...
          >
            <CardBody className="flex items-center justify-center p-8 text-center h-full relative overflow-hidden">
              ...
              <div className="space-y-6 max-w-3xl relative z-10">
                <div
                  className={`p-3 bg-gradient-to-br from-blue-500/20 to-green-500/20 rounded-full w-fit mx-auto transition-all duration-300 ${
                    isHovering ? "scale-110 rotate-12" : ""
                  }`}
                >
                ...
                <div className="space-y-4">
                  ...
                  <div
                    className={`bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10 transition-all duration-300 ${
