  ...
  const features = [
    {
      ...
      description:
        "Track your learning progress with intelligent analytics and personalized recommendations tailored to your study patterns.",
    ...
    },
    {
      ...
      description:
        "Generate and organize study content with AI assistance for enhanced learning experiences.",
    ...
    },
    {
      ...
      description:
        "Access curated educational videos and tutorials designed to accelerate your learning journey.",
    ...
    },
    {
      ...
      description:
        "Connect with learners worldwide through our AI-enhanced platform that brings education to every corner of the globe.",
      skeleton: <SkeletonFour />,
      className: "col-span-1 lg:col-span-3 border-b lg:border-none",
    },
  ];
  return (
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">      <div className="px-8">
        <h4 className="text-3xl lg:text-5xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium text-black dark:text-white">
          Revolutionizing Education with AI
        </h4>

        <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          From personalized learning paths to intelligent content generation, Adhyayan AI transforms the way you learn and teach with cutting-edge artificial intelligence.
        </p>
      </div>
    ...
    >
      <div className="w-full  mx-auto bg-transparent dark:bg-transparent group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  relative">
          {/* TODO */}
          <IconBrandYoutubeFilled className="h-20 w-20 absolute z-10 inset-0 text-red-500 m-auto " />          <img
...
export const SkeletonFour = () => {
  return (
    <div className="h-60 md:h-60  flex flex-col items-center justify-center relative bg-transparent dark:bg-transparent mt-40">
