            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-neutral-400 focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 text-center text-xl font-mono tracking-widest uppercase"
                  maxLength={6}
                  autoComplete="off"
                />
              ...
              <div className="mt-2 text-xs text-neutral-500">
                        ...
                        <button
                          ...
                          disabled={isJoining}
                          className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg font-semibold text-lg hover:from-green-600 hover:to-emerald-700 transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                          {isJoining ? (
                            <>
